...
export const COMPONENT_ASSETS = [
  ...
  asset('floorplan-standard-bedroom', 'floorplan', '普通卧室', { templateId: 'standard-bedroom', supported: true, previewImage:'../../assets/scenes/templates/bay-bedroom.png?v=2', planPreview:{ path:'M18 12H82V88H18Z', dividers:[], windows:[[37,12,63,12]] } }),
