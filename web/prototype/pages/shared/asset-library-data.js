...
export const COMPONENT_ASSETS = [
  ...
  asset('floorplan-square-lounge', 'floorplan', '方形会客厅', { templateId: 'square-lounge', supported: true, previewImage:'../../assets/scenes/templates/square-lounge.png?v=2', planPreview:{ path:'M10 16H90V84H10Z', dividers:[], windows:[[25,16,58,16],[10,48,10,72]] } }),
  ...
  asset('floorplan-standard-bedroom', 'floorplan', '普通方形卧室', { templateId: 'standard-bedroom', supported: true, previewImage:'../../assets/scenes/templates/bay-bedroom.png?v=3', planPreview:{ path:'M16 16H84V84H16Z', dividers:[], windows:[[35,16,65,16]] } }),
